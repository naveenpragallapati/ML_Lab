...
decision_tree_graph.render('original_decision_tree', format='png', cleanup=True)

pruned_tree = prune_tree(decision_tree, training_data, target_column, min_samples=6)
print("Pruned Tree:", pruned_tree)
decision_tree_graph = visualize_tree(pruned_tree, feature_columns)
decision_tree_graph.render('post_pruned_decision_tree', format='png', cleanup=True)
